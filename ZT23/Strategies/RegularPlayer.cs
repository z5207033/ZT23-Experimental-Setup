...
{
    class RegularPlayer<MoveT, GameT, GameStateT> : IPlayer<MoveT, GameT, GameStateT>
        where MoveT : Enum
        where GameT : IGame<MoveT, GameStateT>
        where GameStateT : IGameState<MoveT>
    {
        readonly Random random = new Random();
        readonly RegularStrategy<MoveT, GameT, GameStateT> strategy;
        ...
        public RegularPlayer(RegularStrategy<MoveT, GameT, GameStateT> strategy = null)
        {
            this.strategy = strategy ?? new RegularStrategy<MoveT, GameT, GameStateT>(
    ...
    class RegularStrategy<MoveT, GameT, GameStateT>
        where MoveT : Enum
        where GameT : IGame<MoveT, GameStateT>
        where GameStateT : IGameState<MoveT>
    {
        ...
        private IEnumerable<(GameStateT state, double weight)> GetBeliefsInRealState(GameT game, GameStateT state, int playerId)
        {
            ...
            var simulatedPlayer = new RegularPlayer<MoveT, GameT, GameStateT>(
                new RegularStrategy<MoveT, GameT, GameStateT>(moveValueCache, beliefsInStateCache, bestMoveCache));
